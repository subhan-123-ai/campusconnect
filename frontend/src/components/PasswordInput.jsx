  ...
  return (
    <div className={`relative ${className}`}>
      <input
        ...
        className={`w-full rounded-lg border border-gray-300 px-4 py-2 pr-11 outline-none transition focus:border-transparent focus:ring-2 focus:ring-blue-500 ${inputClassName}`}
      ...
      <button
        ...
        className="absolute right-3 top-1/2 -translate-y-1/2 rounded p-0.5 text-gray-500 hover:text-gray-700"
